...
function createProduct() {
    if (localStorage.getItem('products') == null) {
        let products = [{
            id: 1,
            status: 1,
            title: 'Bó Hoa Len Hướng Dương 1 Bông Handmade',
            img: './assets/img/products/hoahuongduong1bong.png',
            category: 'Hoa len',
            price: 120000,
            desc: 'Hoa len handmade là sản phẩm có độ bền cao, an toàn và thân thiện với môi trường. Mỗi bông hoa len được làm ra tốn rất nhiều thời gian, tâm huyết của những người thợ thủ công và chắc chắn sẽ là món quà ý nghĩa gửi đến những người thân yêu của bạn ᰔᩚ'
        },
        {
            id: 2,
            status: 1,
            title: 'Bó Hoa Len Mix Hoa Hồng Khổng Lồ Và Trái Tim',
            img: './assets/img/products/hoahongbu.png',
            category: 'Hoa len',
            price: 180000,
            desc: 'Hoa len handmade là sản phẩm có độ bền cao, an toàn và thân thiện với môi trường. Mỗi bông hoa len được làm ra tốn rất nhiều thời gian, tâm huyết của những người thợ thủ công và chắc chắn sẽ là món quà ý nghĩa gửi đến những người thân yêu của bạn '
        },
        {
            id: 3,
            status: 1,
            title: 'Hoa cúc Minisize dễ thương',
            img: './assets/img/products/hoacucmini.png',
            category: 'Hoa len',
            price: 180000,
            desc: 'Hoa len handmade là sản phẩm có độ bền cao, an toàn và thân thiện với môi trường. Mỗi bông hoa len được làm ra tốn rất nhiều thời gian, tâm huyết của những người thợ thủ công và chắc chắn sẽ là món quà ý nghĩa gửi đến những người thân yêu của bạn '
        },
        {
            id: 4,
            status: 1,
            title: 'Bó Hoa Hồng Len 3 Bông Mix Hoa 5 Cánh Nhiều Màu Sắc',
            img: './assets/img/products/hoahongnhieumau.png',
            category: 'Hoa len',
            price: 240000,
            desc: 'Hoa len handmade là sản phẩm có độ bền cao, an toàn và thân thiện với môi trường. Mỗi bông hoa len được làm ra tốn rất nhiều thời gian, tâm huyết của những người thợ thủ công và chắc chắn sẽ là món quà ý nghĩa gửi đến những người thân yêu của bạn '
        },
        {
            id: 5,
            status: 1,
            title: 'Vịt Ú Nu Bằng Len Handmade',
            img: './assets/img/products/vitunu.png',
            category: 'Thú bông len',
            price: 100000,
            desc: 'Móc khóa đầu thú dùng làm quà tặng, quà lưu niệm, quà tặng các ngày lễ. Sản phẩm được giao ngẫu nhiên.'
        },
        {
            id: 5,
            status: 1,
            title: 'Túi Len Đi Biển Hoa Daisy Handmade',
            img: './aassets/img/products/tuilendibien.png',
            category: 'Thú bông len',
            price: 100000,
            desc: 'Túi len handmade được làm 100% đan móc thủ công là sản phẩm có độ bền cao, an toàn và thân thiện với môi trường. Mỗi một sản phẩm chứa đựng rất nhiều tâm huyết của những người thợ thủ công và chắc chắn sẽ là món quà ý nghĩa gửi đến những người thân yêu của bạn'
        },
        ]
